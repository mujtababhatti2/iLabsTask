...
export default function () {
  ...
  const iosSafeAreaPadding = {
    paddingTop: safeAreaInsets.top,
    paddingBottom: safeAreaInsets.bottom,
  };
  const iosSafeAreaTPadding = {
    paddingTop: safeAreaInsets.top,
  };
  const iosSafeAreaBPadding = {
    paddingBottom: safeAreaInsets.bottom,
  };
...
const buildTheme = <F, G, I, L, C>(
  ...
  iosSafeAreaPadding: ViewStyle,
  iosSafeAreaTPadding: ViewStyle,
  iosSafeAreaBPadding: ViewStyle,
) => {
  return {
